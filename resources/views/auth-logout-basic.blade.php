                    ...
                    <div class="card mt-4">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="mt-4 pt-2">
                                ...
                                <p class="text-muted">Thank you for using <span class="fw-semibold">bumasis</span>
                                    admin template</p>
                                <div class="mt-4">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        </script> BUMASIS. Crafted with <i
                                class="mdi mdi-heart text-danger"></i> by Bumicode</p>
                    </div>
                </div>
            </div>
        </div>
